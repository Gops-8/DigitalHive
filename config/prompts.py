...
1. Keywords: Identify at least five detailed, long-tail keywords related to the product or service, separated by commas. 
   Never use underscores. If a keyword is multiple words, separate them with a single space. 
   Example: "Award Winning Wedding DJ", "Boutique Guest House South Africa".
